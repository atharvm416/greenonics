...
const DetailleproductpagevTwoOnePage = () => {
    ...
    <>
      <div className="bg-white-A700 flex flex-col font-roboto gap-8 items-start justify-start mx-auto pb-1.5 w-full">
        <div className="flex flex-col items-center w-full">
          <Header1 className="bg-yellow-50 flex flex-col items-center justify-center md:px-5 w-full" />
        </div>
        ...
        <div className="flex flex-col gap-8 items-center w-full">
          <div className="flex flex-col gap-8 items-center justify-start w-auto md:w-full">
                ...
                <div className="flex flex-col gap-2 items-start justify-start w-auto md:w-full">
                  <div className="flex flex-col gap-2 items-start justify-start w-full">
                    <div className="flex flex-col items-center justify-start p-1 w-auto sm:w-full">
                      ...
                      >
                        365 by Whole Foods Market, Flour All Purpose Baking, 80
                        Ounce
                      </Text>
                    </div>
                  ...
                  <div className="flex flex-col gap-2 items-start justify-start w-full">
                    ...
                    <div className="flex md:flex-col flex-row gap-1 items-start justify-start max-w-[641px] p-1 w-full">
                      ...
                      >
                        ...
                        dance-down-the-aisles feeling. Our huge range of choices
                        with high-quality ingredients at prices you can get down
                        with makes grocery shopping so much more than tossing
                        the basics in your cart. It’s the splurgiest way to
                        save.
                      </Text>
                    </div>
                    <div className="flex md:flex-col flex-row gap-1 items-start justify-start max-w-[641px] p-1 w-full">
            ...
            <div className="flex flex-col gap-8 items-center justify-center max-w-[1388px] mx-auto md:px-5 py-4 w-full">
            ...
            >
              <div className="bg-yellow-50_01 flex flex-1 flex-col gap-6 items-center justify-center max-w-[1440px] sm:px-5 px-[29px] py-8 w-full">
                ...
                />
                <div className="gap-[31px] grid sm:grid-cols-1 md:grid-cols-4 grid-cols-7 items-end justify-start max-w-[1362px] mx-auto md:px-5 w-full">
              ...
              <div className="flex flex-1 flex-col gap-6 items-center justify-center max-w-[1440px] sm:px-5 px-[29px] py-8 w-full">
                <CategoryPageVTwoTitleofsection
                  className="flex sm:flex-col flex-row md:gap-10 items-center justify-between max-w-[1368px] mx-auto md:px-5 w-full"
                  ourproduct="Products related To This Item"
                  pagenumber="Vu More"
                />
                <div className="gap-[31px] grid sm:grid-cols-1 md:grid-cols-4 grid-cols-7 items-end justify-start max-w-[1362px] mx-auto md:px-5 w-full">
                  <CategoryPageVTwoUicard1 className="bg-white-A700 flex flex-1 flex-col items-start justify-center px-1 py-2 w-full" />
                  <CategoryPageVTwoUicard1
                    className="bg-white-A700 flex flex-1 flex-col items-start justify-center px-1 py-2 w-full"
                    productimage="images/img_rectangle243_11.png"
                  />
...
export default DetailleproductpagevTwoOnePage;
